...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: loc(lang, {
      ...
      vi: 'Kết bạn tại Hàn Quốc | K-Survival Kit',
    }),
    description: loc(lang, {
      ...
      vi: 'Ứng dụng, sự kiện và cộng đồng để gặp gỡ người mới tại Hàn Quốc.',
    }),
    alternates: {
...
const UI = {
  pageTitle: { en: 'Making Friends in Korea', zh: '在韩国交朋友', ru: 'Знакомства в Корее', ja: '韓国で友達を作ろう', vi: 'Kết bạn tại Hàn Quốc' },
  pageSubtitle: {
  ...
  tip: {
    ...
    vi: '💡 Trao đổi ngôn ngữ là một trong những cách dễ nhất để kết bạn với người Hàn Quốc. Người Hàn đang học tiếng Anh hay ngôn ngữ khác luôn tìm kiếm đối tác bản ngữ.',
  },
};
...
const APPS: Card[] = [
  {
    icon: '🌍',
    name: 'Meetup',
    tag: { en: 'Events & Groups', zh: '活动与团体', ru: 'Мероприятия', ja: 'イベント・グループ', vi: 'Sự kiện & Nhóm' },
    desc: {
      ...
      vi: 'Tìm sự kiện và nhóm tại Hàn Quốc — leo núi, trao đổi ngôn ngữ, cờ bàn, gặp gỡ người nước ngoài và nhiều hơn. Miễn phí tham gia hầu hết sự kiện.',
    },
    url: 'https://www.meetup.com/find/?keywords=korea&source=EVENTS',
    btnColor: 'bg-rose-500',
    btn: { en: 'Find Korea Meetups', zh: '查找韩国聚会', ru: 'Найти встречи в Корее', ja: '韓国のMeetupを探す', vi: 'Tìm Meetup tại Hàn Quốc' },
  },
  {
    icon: '🌐',
    name: 'InterNations',
    tag: { en: 'Expat Community', zh: '外籍人士社区', ru: 'Сообщество экспатов', ja: '外国人コミュニティ', vi: 'Cộng đồng người nước ngoài' },
    desc: {
      ...
      vi: 'Mạng lưới người nước ngoài lớn nhất thế giới. Tham gia chương Hàn Quốc cho sự kiện, diễn đàn và kết nối với người nước ngoài khác.',
    },
    url: 'https://www.internations.org/korea-expats',
    btnColor: 'bg-blue-500',
    btn: { en: 'Join InterNations Korea', zh: '加入InterNations韩国', ru: 'Присоединиться к InterNations', ja: 'InterNations韓国に参加', vi: 'Tham gia InterNations Hàn Quốc' },
  },
  {
    icon: '💬',
    name: 'Tandem',
    tag: { en: 'Language Exchange', zh: '语言交换', ru: 'Языковой обмен', ja: '言語交換', vi: 'Trao đổi ngôn ngữ' },
    desc: {
      ...
      vi: 'Tìm đối tác tiếng Hàn muốn học ngôn ngữ của bạn. Chat qua văn bản, giọng nói hoặc video — cách tự nhiên để kết bạn người Hàn.',
    },
    url: 'https://www.tandem.net',
    btnColor: 'bg-violet-500',
    btn: { en: 'Find a Language Partner', zh: '寻找语言伙伴', ru: 'Найти партнёра', ja: '言語パートナーを探す', vi: 'Tìm đối tác ngôn ngữ' },
  },
  {
    icon: '📱',
    name: 'HelloTalk',
    ...
    desc: {
      ...
      vi: 'Chat với người nói tiếng Hàn bản ngữ muốn luyện ngôn ngữ của bạn. Công cụ dịch và chỉnh sửa tích hợp giúp trò chuyện dễ dàng.',
    },
    url: 'https://www.hellotalk.com',
    btnColor: 'bg-emerald-500',
    btn: { en: 'Open HelloTalk', zh: '打开HelloTalk', ru: 'Открыть HelloTalk', ja: 'HelloTalkを開く', vi: 'Mở HelloTalk' },
  },
  {
    icon: '🏫',
    name: 'University International Office',
    tag: { en: 'On Campus', zh: '校内资源', ru: 'В кампусе', ja: 'キャンパス内', vi: 'Trong khuôn viên' },
    desc: {
      ...
      vi: 'Kiểm tra văn phòng quốc tế của trường bạn để tìm chương trình buddy, sự kiện định hướng và câu lạc bộ sinh viên. Đây thường là cách dễ nhất để gặp cả người Hàn lẫn sinh viên quốc tế.',
    },
    url: 'https://www.google.com/search?q=korea+university+international+student+buddy+program',
    btnColor: 'bg-slate-600',
    btn: { en: 'Search Buddy Programs', zh: '搜索结对项目', ru: 'Найти программы', ja: 'バディプログラムを探す', vi: 'Tìm chương trình Buddy' },
  },
  {
    icon: '🎮',
    name: 'Facebook Groups',
    tag: { en: 'Online Community', zh: '线上社区', ru: 'Онлайн-сообщество', ja: 'オンラインコミュニティ', vi: 'Cộng đồng trực tuyến' },
    desc: {
      ...
      vi: 'Tham gia nhóm Facebook như "Foreigners in Korea", "Seoul Expats", hoặc nhóm riêng cho thành phố của bạn. Rất tốt để hỏi và tìm địa điểm vui chơi.',
    },
    url: 'https://www.facebook.com/search/groups?q=foreigners%20in%20korea',
    btnColor: 'bg-blue-600',
    btn: { en: 'Find Facebook Groups', zh: '查找Facebook群组', ru: 'Найти группы', ja: 'Facebookグループを探す', vi: 'Tìm nhóm Facebook' },
  },
];
...
const TIPS: { icon: string; title: Record<L, string>; body: Record<L, string> }[] = [
  {
    icon: '🗣️',
    title: { en: 'Try even a little Korean', zh: '尝试说几句韩语', ru: 'Попробуйте говорить по-корейски', ja: '少しでも韓国語を試してみよう', vi: 'Thử nói một chút tiếng Hàn' },
    body: {
      ...
      vi: 'Người Hàn rất trân trọng mọi nỗ lực nói tiếng Hàn, dù chỉ là câu chào cơ bản. Một câu "안녕하세요" đơn giản cũng tạo ấn tượng lớn.',
    },
  },
  {
    icon: '🍻',
    title: { en: 'Join hoesik (회식)', zh: '参加회식（聚餐）', ru: 'Участвуйте в хвесик (회식)', ja: '회식（飲み会）に参加しよう', vi: 'Tham gia hoesik (회식)' },
    body: {
      ...
      vi: 'Bữa ăn tập thể và hoạt động nhóm (회식) là trung tâm của cuộc sống xã hội Hàn Quốc. Nếu được mời, đi một lần cũng tạo sự kết nối lớn.',
    },
  },
  {
    icon: '📚',
    title: { en: 'Take a Korean language class', zh: '参加韩语课', ru: 'Запишитесь на курс корейского', ja: '韓国語クラスに参加しよう', vi: 'Tham gia lớp học tiếng Hàn' },
    body: {
      ...
      vi: 'Chương trình ngôn ngữ của trường thường kết hợp sinh viên Hàn và quốc tế. Đây là môi trường có cấu trúc để tình bạn hình thành tự nhiên.',
    },
  },
];
