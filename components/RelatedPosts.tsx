...
const allRelated: Record<string, RelatedPost> = {
  'getting-started': {
    ...
    icon: '🚀',
    eyebrow: { en: 'First Steps', zh: '入门须知', ru: 'С чего начать', ja: 'はじめの一歩', vi: 'Bước đầu tiên' },
    title: { en: 'Getting Started', zh: '入门指南', ru: 'Начало', ja: '始め方', vi: 'Bắt đầu' },
    description: {
      ...
      vi: 'Thẻ ARC, SIM, tài khoản ngân hàng và những việc cần làm trong tuần đầu.',
    },
  },
  'daily-life': {
    href: '/daily-life',
    icon: '🌆',
    eyebrow: { en: 'Everyday', zh: '日常生活', ru: 'Быт', ja: '日常生活', vi: 'Hàng ngày' },
    title: { en: 'Daily Life', zh: '日常生活指南', ru: 'Повседневная жизнь', ja: '日常生活ガイド', vi: 'Cuộc sống hàng ngày' },
    description: {
      ...
      vi: 'Giao thông, mua sắm, ứng dụng giao đồ ăn và quy tắc rác thải.',
    },
  },
  health: {
    href: '/health',
    icon: '🏥',
    eyebrow: { en: 'Medical', zh: '医疗', ru: 'Здоровье', ja: '医療', vi: 'Y tế' },
    title: { en: 'Health & Emergency', zh: '医疗与紧急情况', ru: 'Здоровье и экстренные случаи', ja: '健康・緊急対応', vi: 'Sức khỏe & Khẩn cấp' },
    description: {
      en: 'Hospitals, insurance, pharmacies, and emergency contacts.',
      zh: '医院、保险、药店及紧急联系方式。',
      ru: 'Больницы, страховка, аптеки и экстренные номера.',
      ja: '病院・保険・薬局・緊急連絡先。',
      vi: 'Bệnh viện, bảo hiểm, nhà thuốc và số liên lạc khẩn cấp.',
    },
  },
  housing: {
    href: '/housing',
    icon: '🏠',
    eyebrow: { en: 'Where you live', zh: '住所', ru: 'Жильё', ja: '住まい', vi: 'Nơi bạn sống' },
    title: { en: 'Housing Guide', zh: '住房指南', ru: 'Гайд по жилью', ja: '住まいガイド', vi: 'Hướng dẫn nhà ở' },
    description: {
      ...
      vi: 'Ký túc xá, phòng trọ, tiền đặt cọc và hợp đồng thuê nhà.',
    },
  },
  culture: {
    href: '/culture',
    icon: '🎎',
    eyebrow: { en: 'Life tips', zh: '生活技巧', ru: 'Советы', ja: '生活tips', vi: 'Mẹo cuộc sống' },
    title: { en: 'Culture & Etiquette', zh: '文化与礼仪', ru: 'Культура и этикет', ja: '文化・マナー', vi: 'Văn hóa & Phép lịch sự' },
    description: {
      ...
      vi: 'Phép lịch sự cơ bản, quy tắc xã hội và cách cư xử nơi công cộng.',
    },
  },
  visa: {
    href: '/visa',
    icon: '🛂',
    eyebrow: { en: 'Stay legal', zh: '签证合法', ru: 'Легальный статус', ja: 'ビザ', vi: 'Ở lại hợp pháp' },
    title: { en: 'Visa & Immigration', zh: '签证与出入境', ru: 'Виза и иммиграция', ja: 'ビザ・在留資格', vi: 'Visa & Nhập cư' },
    description: {
      ...
      vi: 'Các loại visa, thẻ ARC, gia hạn và quy định nhập cư.',
    },
  },
  'arc-card-korea-guide': {
    href: '/arc-card-korea-guide',
    icon: '🪪',
    eyebrow: { en: 'Guide', zh: '指南', ru: 'Гайд', ja: 'ガイド', vi: 'Hướng dẫn' },
    title: {
      en: 'ARC Card Guide',
      zh: '外国人登录证(ARC)申请指南',
      ru: 'Гайд по карте ARC',
      ja: '外国人登録証（ARC）ガイド',
      vi: 'Hướng dẫn thẻ ARC',
    },
    description: {
      ...
      vi: 'Hướng dẫn từng bước làm thẻ ARC tại Hàn Quốc.',
    },
  },
  'best-bank-account-for-foreigners-korea': {
    href: '/best-bank-account-for-foreigners-korea',
    icon: '🏦',
    eyebrow: { en: 'Banking', zh: '银行', ru: 'Банки', ja: '銀行', vi: 'Ngân hàng' },
    title: {
      en: 'Best Bank Account',
      zh: '最佳银行账户',
      ru: 'Лучший банк',
      ja: 'おすすめ銀行口座',
      vi: 'Tài khoản ngân hàng tốt nhất',
    },
    description: {
      ...
      vi: 'Ngân hàng Hàn Quốc nào dễ mở nhất cho người nước ngoài.',
    },
  },
  'how-to-get-sim-card-in-korea': {
    href: '/how-to-get-sim-card-in-korea',
    icon: '📱',
    eyebrow: { en: 'SIM Card', zh: 'SIM卡', ru: 'SIM-карта', ja: 'SIMカード', vi: 'SIM' },
    title: {
    ...
    description: {
      ...
      vi: 'Cách mua SIM hoặc eSIM với tư cách người nước ngoài tại Hàn Quốc.',
    },
  },
  'korea-delivery-apps-guide': {
    href: '/korea-delivery-apps-guide',
    icon: '🛵',
    eyebrow: { en: 'Apps', zh: '外卖App', ru: 'Приложения', ja: 'アプリ', vi: 'Ứng dụng' },
    title: {
      en: 'Korea Delivery Apps',
      zh: '韩国外卖App指南',
      ru: 'Приложения доставки еды',
      ja: '韓国デリバリーアプリ',
      vi: 'App giao đồ ăn Hàn Quốc',
    },
    description: {
      ...
      vi: 'Baemin, Coupang Eats và cách sử dụng chúng với tư cách người nước ngoài.',
    },
  },
  'korea-rent-deposit-system': {
    href: '/korea-rent-deposit-system',
    icon: '🏘️',
    eyebrow: { en: 'Housing', zh: '住房', ru: 'Жильё', ja: '住まい', vi: 'Nhà ở' },
    title: {
      en: 'Rent Deposit System',
      zh: '租房保证金制度',
      ru: 'Система аренды жилья',
      ja: '賃貸保証金制度',
      vi: 'Hệ thống đặt cọc thuê nhà',
    },
    description: {
      ...
      vi: 'Jeonse vs Wolse — hệ thống đặt cọc thuê nhà độc đáo của Hàn Quốc.',
    },
  },
  'how-to-send-money-from-korea': {
    href: '/how-to-send-money-from-korea',
    icon: '💸',
    eyebrow: { en: 'Money', zh: '汇款', ru: 'Деньги', ja: '送金', vi: 'Chuyển tiền' },
    title: {
      en: 'Send Money from Korea',
      zh: '从韩国向海外汇款',
      ru: 'Отправить деньги из Кореи',
      ja: '韓国から海外送金',
      vi: 'Chuyển tiền từ Hàn Quốc',
    },
    description: {
